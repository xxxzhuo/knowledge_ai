...
class Settings(BaseSettings):
    ...
    # 向量库配置
    vector_store_type: Literal["faiss", "milvus", "pgvector", "aliyun"] = "aliyun"
    milvus_host: str = "localhost"
    milvus_port: int = 19530
    vector_dimension: int = 768  # embeddinggemma: 768, text-embedding-3-large: 1536

    # 阿里云向量存储 (OSS V2 Vector Index) 配置
    ...
    aliyun_region: str = ""                 # e.g. cn-shenzhen (V2 SDK 必填)
    aliyun_account_id: str = ""             # 阿里云账号 ID (V2 SDK 必填)
